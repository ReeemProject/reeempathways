...
import { Flex } from '../src/components/mdxComponents/general'
...
<Flex><RenderCharts config={economy1} /><RenderCharts config={health1} /><RenderCharts config={criticalmaterials1} /></Flex>
