...
import energy1 from '../../data/energy/energy1'
...
1.	_Technology innovation outlooks_ developed in Technology Innovation Roadmaps are integrated, with focus on storage options, renewable energy technologies and heat savings in residential buildings. Those roadmaps provide certain techno-economic figures which are used as input parameters in TIMES PanEU.
2.	An assessment of the _health impacts_ of _emissions_ by the energy sector is carried out. For this purpose, a soft-link is established between TIMES PanEU and EcoSense, where the former takes figures from the latter and uses those as externalities.
3.	A step is to improve representation of some key _regional and local specificities of the energy system development_ of selected EU countries. This part builds on a harmonisation process between TIMES PanEU and case study models focusing on energy supply security and grid and dispatch with the help of the experts in the case study regions, existing base year capacities and electricity trade flow between the regions are improved and the planned capacities from ENTSO-E are incorporated into the model as well. 
4.	A further step is the inclusion of _impacts of consumers’ technology choices_. The main drivers of consumers’ choices regarding heating and transportation are drawn from surveys through a novel discrete choice model. Selected insights are included in TIMES PanEU. The methodology is explained in deliverable D6.1 – Integrated Energy System Model, available [here](http://www.reeem.org/index.php/deliverables-by-theme/).
5.	_The effect of climate changes on heating and cooling demand_ across the EU is evaluated starting from climate databases. In turn, the effect of these changes on the energy demand-supply balance and investment requirements is assessed through TIMES PanEU.
...
![Net electricity generation in the EU28](./1_energy_figure5.png)
...
![Primary Energy Consumption](./1_energy_figure6.png)
...
![Final energy consumption by industry](./1_energy_figure7.png)
Figure 7. Final energy consumption by industry [PJ].

![Final Energy Consumption by Transport](./1_energy_figure8.png)
...
![CO2 emissions in the EU28](./1_energy_figure9.png)
...
![Final energy consumption in the residential sector](./1_energy_figure10.png)
Figure 10. Final energy consumption in the residential sector [PJ].

![Total Final Energy Consumption](./1_energy_figure11.png)
