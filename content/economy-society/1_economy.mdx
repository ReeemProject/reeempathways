...
import economy1 from '../../data/economy/economy1'
...
![Key pathway assumptions for the economic impacts analysis](./1_economy_table4.png)

Table 4. Key pathway assumptions for the economic impacts analysis.

![Country index for the current study](./1_economy_table5.png)
...
![Competitiveness index (GVA) development](./1_economy_figure16.png)
...
![GDP difference relative to RF pathway for the European Regions in NEWAGE](./1_economy_figure17.png) 
...
![Consumption of specific EG in the EU-28 according to income level](./1_economy_figure18.png)
...
![Development of gross income for the 20% poorest households (hh1) and 20% richest households (hh5)](./1_economy_figure19.png)
